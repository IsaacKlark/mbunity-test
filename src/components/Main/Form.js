...
import { Wrapper, FieldWrapper, FieldsWrapper, Text, CustomField, Error, Radio, 
  RadioHead, RadioLabel, RadioText, Button, ButtonWrapper, RadioWrapper, EmptyRadio, 
  PlaneImage } from './formStyles';
      ...
      <Wrapper>
        ...
        <RadioWrapper>
          <RadioLabel htmlFor="option1">
            {selectedRadio === radioVars[0] ? <img src={Tick} alt="selected" /> : <EmptyRadio />}
          ...
          <RadioLabel htmlFor="option2">
            {selectedRadio === radioVars[1] ? <img src={Tick} alt="selected" /> : <EmptyRadio />}
            <RadioText>General Inquiry</RadioText>
            <Radio type="radio"
              name="options"
              value="option2"
          ...
          <RadioLabel htmlFor="option3">
            {selectedRadio === radioVars[2] ? <img src={Tick} alt="selected" /> : <EmptyRadio />}
            <RadioText>General Inquiry</RadioText>
            <Radio type="radio"
              name="options"
              value="option3"
          ...
          <RadioLabel htmlFor="option4">
            {selectedRadio === radioVars[3] ? <img src={Tick} alt="selected" /> : <EmptyRadio />}
            <RadioText>General Inquiry</RadioText>
            <Radio type="radio"
              name="options"
              value="option4"
